...
class CambioCategoriaEngordeFragment : Fragment() {
    ...
    private fun clickCambioEngorde() {
        val url= "https://vaquijpa2-production.up.railway.app/ingresarEngorde/${id_cambio_engorde.text}"
    ...
    private fun eliminarCategoria() {
        val url = "https://vaquijpa2-production.up.railway.app/${funcion_eliminar_engorde.text}${id_cambio_engorde.text}"
        val queue = Volley.newRequestQueue(requireContext())
