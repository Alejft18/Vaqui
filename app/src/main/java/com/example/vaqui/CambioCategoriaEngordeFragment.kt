...
class CambioCategoriaEngordeFragment : Fragment() {
    ...
    private fun clickCambioEngorde() {
        val url= "http://192.168.208.187:8080/ingresarEngorde/${id_cambio_engorde.text}"
    ...
    private fun eliminarCategoria() {
        val url = "http://192.168.208.187:8080/${funcion_eliminar_engorde.text}${id_cambio_engorde.text}"
        val queue = Volley.newRequestQueue(requireContext())
